...
class KBPSMPAgent(object):
    def __init__(self, model_func, exploration_schedule, obs_shape, lr=1e-4, buffer_size=1000000,
                 ...
                 gamma=0.99, knn=10, eval_epsilon=0.01, queue_threshold = 1e-7,
                 tf_writer=None):
        self.conn, child_conn = Pipe()
        self.queue_threshold = queue_threshold
        self.ec_buffer = KernelBasedPriorSweepProcess(num_actions, buffer_size, latent_dim, latent_dim, child_conn, gamma)
        self.obs = None
        self.z = None
        self.ind = -1
