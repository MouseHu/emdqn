...
if __name__ == '__main__':
    ...
    subdir = (datetime.datetime.now()).strftime("%m-%d-%Y-%H:%M:%S") + "_" + str(args.comment)
    print("subdir", subdir)
    print("agent", args.agent_dir)
    print("comment", type(args.comment), args.comment)
    print("comment", type(args.comment), str(args.comment))
