...
def build_act_dqn(make_obs_ph, q_func, num_actions, scope="deepq", reuse=None):
...
def build_train_dqn(make_obs_ph, q_func, num_actions, optimizer, grad_norm_clipping=None, gamma=1.0,
...
`       See the top of the file for details.
    ...
    if param_noise:
        ...
        act_f = build_act_dqn(make_obs_ph, q_func, num_actions, scope=scope, reuse=reuse)
